...
describe("MobileMenu", () => {
    ...
    it("renders two MenuLink providing two elements in links prop", () => {
        const element = shallow(
            <MobileMenu links={[{ label: "label1", url: "url1" }, { label: "label2", url: "url2" }]} />
        );
    ...
    it("provides to label prop of MenuLink the value of label attribute of links objects", () => {
        const element = shallow(<MobileMenu links={[{ label: "this is a label", url: "this is an url" }]} />);
        expect(
            element
                .find(MenuLink)
                .at(0)
